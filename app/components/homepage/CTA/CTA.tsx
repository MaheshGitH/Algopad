...
const CTA = () => {
  return (
    <div
      id="demo-account"
      className="border-2 border-primary font-nunito text-base flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6 rounded-2xl px-8 py-9 mx-4 max-w-5xl lg:w-full lg:mx-auto"
    >
